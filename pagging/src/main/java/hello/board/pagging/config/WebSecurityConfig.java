package hello.board.pagging.config;

import hello.board.pagging.config.filter.CustomAuthenticationProvider;
import hello.board.pagging.config.filter.MemberCustomAuthenticationFilter;
import hello.board.pagging.config.handler.MemberCustomLoginFailHandler;
import hello.board.pagging.config.handler.MemberCustomLoginSuccessHandler;
import hello.board.pagging.config.handler.WebAccessDeniedHandler;
import hello.board.pagging.config.handler.WebAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable() // csrf 보안 설정 비활성화
                ...
                .antMatchers("/boardView/**").hasAnyRole("ADMIN", "USER") // ROLE_ADMIN 혹은 ROLE_USER 권한을 가진 사용자만 접근 허용
